...
{
    public partial class tabLeftBufferManu3 : Form, IForm
    {
        public tabLeftBufferManu3()
        {
            InitializeComponent();
        ...
        private void UpdateState()
        {
            disp_YReadyPos.ButtonPush = Util.IsAxisInPos(
                (AXIS.CAM_TRANSFER_LEFT_Y, RecipeDefine.POSITION.CAM_TRANSFER_Y_READY_L_POS));

            disp_YLoadingPos.ButtonPush = Util.IsAxisInPos(
                (AXIS.CAM_TRANSFER_LEFT_Y, RecipeDefine.POSITION.CAM_TRANSFER_Y_LOADING_L_POS));

            disp_YPeelingPos.ButtonPush = Util.IsAxisInPos(
                (AXIS.CAM_TRANSFER_LEFT_Y, RecipeDefine.POSITION.CAM_TRANSFER_Y_PEELING_L_POS));

            disp_YUnloadingPos.ButtonPush = Util.IsAxisInPos(
                (AXIS.CAM_TRANSFER_LEFT_Y, RecipeDefine.POSITION.CAM_TRANSFER_Y_UNLOADING_L_POS));
        }
        ...
        {
            //LogUtil.Instance.Log(LOG_TYPE.UI, "Left TRF Buffer Move to Ready Pos Button Click", CONTENT_TYPE.INFO);

            //Machine.IO.GetIn((int)DI.PEELING_L1_TURN, ref ret1);
            //Machine.IO.GetIn((int)DI.PEELING_L2_TURN, ref ret2);
            //if (ret1 == 1 || ret2 == 1)
            //{
            ...
            //    return;
            //}
            //Machine.IO.GetIn((int)DI.PEELING_L1_Z1_UP, ref ret1);
            //Machine.IO.GetIn((int)DI.PEELING_L1_Z2_UP, ref ret2);
            //Machine.IO.GetIn((int)DI.PEELING_L2_Z1_UP, ref ret3);
            //Machine.IO.GetIn((int)DI.PEELING_L2_Z2_UP, ref ret4);
            ...
            //    return;
            //}
            //var proc = Machine.proclist[(int)Machine.PROCESS.LEFTBUF] as ProcessBufStageOne;
        ...
        {
            //LogUtil.Instance.Log(LOG_TYPE.UI, "Left TRF Buffer Move to Loading Pos Button Click", CONTENT_TYPE.INFO);
        ...
        {
            //LogUtil.Instance.Log(LOG_TYPE.UI, "Left TRF Buffer Move to Peeling Pos Button Click", CONTENT_TYPE.INFO);
        ...
        {
            //LogUtil.Instance.Log(LOG_TYPE.UI, "Left TRF Buffer Move to Unloading Pos Button Click", CONTENT_TYPE.INFO);
            //Machine.IO.GetIn((int)DI.PEELING_L1_TURN, ref ret1);
            //Machine.IO.GetIn((int)DI.PEELING_L2_TURN, ref ret2);
            //if (ret1 == 1 || ret2 == 1)
            //{
        ...
        {
            LogUtil.Instance.Log(LOG_TYPE.UI, "Left Buffer Loading Process Button Click", CONTENT_TYPE.INFO);
        ...
        {
            LogUtil.Instance.Log(LOG_TYPE.UI, "Left Buffer Trasnfer Process Button Click", CONTENT_TYPE.INFO);
        ...
        {
            LogUtil.Instance.Log(LOG_TYPE.UI, "Left Buffer Transfer Unload Process Button Click", CONTENT_TYPE.INFO);
        ...
        {
            LogUtil.Instance.Log(LOG_TYPE.UI, "Left Buffer Unloading Process Button Click", CONTENT_TYPE.INFO);
        ...
        public void SetBtnClickEvents()
        {
            ...
            this.button_Peeling1ReturnTurn.MsgEvent = "Set " + "Left Peeling 1" + "Turn ?";
            this.button_Peeling1ReturnTurn.MsgEvent2 = "Set " + "Left Peeling 1" + "Return ?";

            this.button_Peeling2ReturnTurn.ClickEvent += new System.EventHandler(this.button_Peeling2ReturnTurn_Click);
            this.button_Peeling2ReturnTurn.MsgEvent = "Set " + "Left Peeling 2" + "Turn ?";
            this.button_Peeling2ReturnTurn.MsgEvent2 = "Set " + "Left Peeling 2" + "Return ?";

            this.button_PeelingBlow.ClickEvent += new System.EventHandler(this.button_PeelingBlow_Click);
            this.button_PeelingBlow.MsgEvent = "Set " + "Left DustBox " + "Blow ?";
